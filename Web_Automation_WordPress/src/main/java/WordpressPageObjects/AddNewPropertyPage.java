	...
	public static void addNewProperty() {
		try {
			...
			for (int rowIndex = 1; rowIndex <= sheet.getLastRowNum(); rowIndex++) {
				...
				driver.findElement(By.xpath("//label[contains(text(),'" + propertyStatus + "')]/input")).click();
				...
				if (Country != null)
					wait.until(ExpectedConditions
							.visibilityOfElementLocated(By.xpath("//label[contains(text(),'" + Country + "')]/input")));
				...
				je.executeScript("arguments[0].scrollIntoView(true);", driver.findElement(By.xpath(property_id)));
				...
				if (PriceLabel != null)
					je.executeScript("arguments[0].scrollIntoView(true);", driver.findElement(By.xpath(price_label)));
				...
				if (Size != null)
					je.executeScript("arguments[0].scrollIntoView(true);", driver.findElement(By.xpath(property_size)));
				...
				if (SizeLabel != null)
					je.executeScript("arguments[0].scrollIntoView(true);", driver.findElement(By.xpath(size_label)));
				...
				if (row != null) {
					...
					if (cell != null) {
						// Found column and there is value in the cell.
						int bedroom = (int) cell.getNumericCellValue();
						Bedrooms = String.valueOf(bedroom);
					}
				}
				if (Bedrooms != null)
					je.executeScript("arguments[0].scrollIntoView(true);",
				...
				if (Year != null)
					je.executeScript("arguments[0].scrollIntoView(true);", driver.findElement(By.xpath(property_year)));
				...
				if (Contact != null)
					je.executeScript("arguments[0].scrollIntoView(true);", driver.findElement(By.xpath(contact)));
